...
def getsamp(mu='mu20'):
    sampdict = {
        ...
        'voronoi_cvf':'20150406.11.52_pileup.PythJ1and2mc12aJETMET_short.jetmet2012pileupcustom.root', #in /output/atlas/acukierm
	'voronoi_cvf_short':'20150402.14.20_pileup.PythJ1and2mc12aJETMET_short.jetmet2012pileupcustom.root', #in /ProofAna/run
        }
    return sampdict[mu]
